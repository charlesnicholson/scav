...
table. The table is generated rather than hand-written and the generated file is
committed, so a build needs no network and no Python -- run this only when the
pinned Unicode version moves.

    tools/gen_unicode_tables.py --download
    tools/gen_unicode_tables.py --ucd-dir /path/to/ucd
...
Outputs:
    src/core/lang/unicode_nfc_tables.inc        production tables
    src/core/lang/unicode_nfc_vectors.inc       test-only conformance vectors
"""
...
BANNER = """// GENERATED by tools/gen_unicode_tables.py from Unicode {version}. Do not edit.
//
...
def main() -> int:
    ...
    ap.add_argument("--ucd-dir", type=Path, default=Path("out/ucd"))
    ap.add_argument("--download", action="store_true")
    ap.add_argument("--out-dir", type=Path, default=Path("src/core/lang"))
    args = ap.parse_args()
