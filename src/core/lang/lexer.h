#ifndef SCAV_CORE_LANG_LEXER_H_INCLUDED
#define SCAV_CORE_LANG_LEXER_H_INCLUDED

// Bytes in, one flat token vector out. Not a pull or callback lexer: PRD 17
// asks for a throughput floor on lex and on parse *separately*, which needs a
...
#endif  // SCAV_CORE_LANG_LEXER_H_INCLUDED
