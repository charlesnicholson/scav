#ifndef SCAV_CORE_TESTS_TEST_SYNTH_DOCUMENT_H_INCLUDED
#define SCAV_CORE_TESTS_TEST_SYNTH_DOCUMENT_H_INCLUDED
...
#endif  // SCAV_CORE_TESTS_TEST_SYNTH_DOCUMENT_H_INCLUDED
