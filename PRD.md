...
- ~~The coordinate extent estimate (§11.2) is derived, not measured.~~ **Settled by measurement**, twice: 1.9x headroom under P4's fabricated advances, 5.2x under P5a's real font (§11.2). The fabricated case is the bound that trips first and stays asserted, because P6's rank and node separation grow boxes.
