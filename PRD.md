...
|---|---|
| PB bootstrap, P0 language, P1 model spine, P2 loader, P3 printer and CLI, P4 space tables, P5a metrics + `DrawList` + reference builder, P5b SVG + baseline harness, P5c ABI JSON + Python binding, P6 real layout, P7a router boundary, P7b orthogonal router, P7c nudging, P7d label placement, inflation, and the bench | **the blind review's recorded result** — it ran at P7b and only the compaction finding was written down (§11.12) · the combinatorial nudging stage (§11.5) · rip-up-and-reroute for the boxes no strip fits (§11.9) · P8 determinism infrastructure and `selftest` (§6) · P9 search and calibration (§11.10) · P10 viewer · P11 wasm · P12 editor |
