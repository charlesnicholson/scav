...
|---|---|
| PB bootstrap, P0 language, P1 model spine, P2 loader, P3 printer and CLI, P4 space tables, P5a metrics + `DrawList` + reference builder, P5b SVG + baseline harness, P5c ABI JSON + Python binding, P6 real layout, P7a router boundary, P7b orthogonal router, P7c nudging, P7d label placement, inflation, and the bench | **the incumbent comparison**, rescheduled to P9's exit because a single-candidate render measures the missing search (§11.12) · the combinatorial nudging stage (§11.5) · rip-up-and-reroute for the boxes no strip fits (§11.9) · P8 determinism infrastructure and `selftest` (§6) · P9 search and calibration (§11.10) · P10 viewer · P11 wasm · P12 editor |
...
**P7 — orthogonal routing.** Router behind its own boundary, separated OVG, A* with bend state, obstacles including submachines and placed boxes, LCA-owned separator channels, combinatorial nudging with integer offsets, `PathBox` strip placement, bench harness over ≥2 routers. It splits in four.
